            ...
            <section className="featured">
                <div className="section-header">
                    <div className="section-title-container">
                        ...
                        <p className="section-subtitle">Handpicked articles from our community</p>
                    </div>
                </div>
                <div className="container">
                    <div className="featured-grid">
                        {blogPosts.slice(0, 3).map(post => (
                            <Link key={post.id} to={`/readpost/${post.id}`} className="card-link">
            ...
            <section className="all-posts">
                <div className="section-header">
                    <div className="section-title-container">
                        ...
                        <p className="section-subtitle">Discover knowledge across all topics</p>
                    </div>
                </div>
                <div className="container">
